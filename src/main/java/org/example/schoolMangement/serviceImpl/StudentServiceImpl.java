...
public class StudentServiceImpl implements StudentService {
    ...
    public void take_course(Students students, Courses courses) {
        if (students.getName() != null) {
            ...
            listOfCoursesAndStudents.put(students.getName(), courses.getCourse_title());
            ...
            while (itr.hasNext()) {
                ...
                System.out.println("  ");
                System.out.println(students.getName()+ " "+" now takes this course");
    ...
    public void register(Staff staff, Students students, Levels levels) {
        if (students.getName() != null && staff.getJob() == Job.TEACHER  ) {
            Map<String, LevelName> listOfStudentsAndLevels = new HashMap<>();
            listOfStudentsAndLevels.put(students.getName(), levels.getLevelName());
            ...
            while (itrl.hasNext()) {
                ...
                System.out.println(students.getName() + " Congratulations and Welcome to this new class!!  ");
