...
public class PrincipalServiceImpl implements PrincipalService  {
    ...
    public void admit(Applicants applicant, Staff staffMember) {
        if (staffMember.getJob() == Job.PRINCIPAL) {
            if (applicant.getAge() >= 12) {
                ...
                System.out.println("this  Student" + " " + applicant.getName() + "  " + "has just been admitted " + "  " + "on" + "  " + "Date: " + LocalDate.now() + "  " + "Time: " + LocalTime.now());
   ...
   public void hire(Staff staff) {
        if (staff.getJob()==null){
            ...
            System.out.println("this staff" + " "+ staff.getName()+ "  has been hired to a post of :   "+ staff.getJob());
        }else{
    ...
    public void expel(Staff staff, Students students) {
        ...
        if (staff.getJob() == Job.PRINCIPAL) {
            if (ans == true) {
                ...
                System.out.println(students.getName() + "  has been expelled");
    ...
    public void check_performance(Staff staff) {
        ...
        Scanner scanner = new Scanner(System.in);
        System.out.println("HOW HAVE YOU SEEN THE PERFORMANCE OF   "+ staff.getName()+ "  as a  "+ staff.getJob());
