...
public abstract class User {
    ...
    public User(String name, long phoneNumber, String address, String email, Gender gender, LocalDate dateOfbirth, int age, String stateOfOrigin, String localGovernmentOforigin, String nextOfKin, long nextOfkinphone, BloodGroup bloodGroup, Genotype genotype, String underlyingAilment) {
        this.name = name;
        this.phoneNumber = phoneNumber;
        this.address = address;
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        return phoneNumber == user.phoneNumber && age == user.age && Objects.equals(name, user.name) && Objects.equals(address, user.address) && Objects.equals(email, user.email) && gender == user.gender && Objects.equals(dateOfbirth, user.dateOfbirth) && Objects.equals(stateOfOrigin, user.stateOfOrigin) && Objects.equals(localGovernmentOforigin, user.localGovernmentOforigin) && Objects.equals(NextOfKin, user.NextOfKin) && Objects.equals(nextOfkinphone, user.nextOfkinphone) && BloodGroup == user.BloodGroup && genotype == user.genotype && Objects.equals(underlyingAilment, user.underlyingAilment);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, phoneNumber, address, email, gender, dateOfbirth, age, stateOfOrigin, localGovernmentOforigin, NextOfKin, nextOfkinphone, BloodGroup, genotype, underlyingAilment);
    }
